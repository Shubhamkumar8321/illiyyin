...
//           // ✅ Merge fallback donations if missing
//           const mergedCampaign = {
//             ...c,
//             images: imageArray,
//             donations: c.donations ?? fallbackCampaignData.donations,
//           };
...
//         <button className="w-[70%] bg-green-600 text-white py-2 rounded-full font-semibold text-lg">
//           Donate
//         </button>
//         <button
